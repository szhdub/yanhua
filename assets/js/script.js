...
function randomShellName() {
	return Math.random() < 0.5 ? 'Crysanthemum 菊花' : shellNames[(Math.random() * (shellNames.length - 1) + 1) | 0 ];
}
...
const fastShellBlacklist = ['Falling Leaves 落叶', 'Floral 花卉喷', 'Willow 柳形瀑布'];
